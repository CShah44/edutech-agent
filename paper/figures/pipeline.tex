...
% Annotations
\node[right=0.5cm of breakdown, text width=2cm, align=left, font=\small] {Decomposes into targeted components};
\node[right=0.5cm of synthesis, text width=2cm, align=left, font=\small] {Adaptive strategy selection};
